class DateFormatUtil {
  ...
  static String dateFormat(DateTime date, List<String> formats) {
  ...
  static const List<String> monthShort = <String>[
    'Jan',
    'Feb',
    'Mar',
    'Apr',
  ...
  static const List<String> monthLong = <String>[
    'January',
    'February',
    'March',
    'April',
  ...
  static const List<String> dayShort = <String>[
    'Mon',
    'Tue',
    'Wed',
    'Thur',
  ...
  static const List<String> dayLong = <String>[
    'Monday',
    'Tuesday',
    'Wednesday',
    'Thursday',
