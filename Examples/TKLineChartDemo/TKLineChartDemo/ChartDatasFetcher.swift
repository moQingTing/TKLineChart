...
//        }
        ...
        let url = URL(string: self.apiURL + "/market/candles?instId=\(symbol)&bar=\(timeType)&limit=\(size)")
                ...
                DispatchQueue.main.async {
                    ...
                    do {
                        ...
                        if let jsonDict = json,
                           let chartDatasArray = jsonDict["data"] as? [[Any]] {
                            for dataArray in chartDatasArray {
                                let marketData = KlineChartData(array: dataArray)
