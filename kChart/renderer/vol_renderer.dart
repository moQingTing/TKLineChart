...
class VolRenderer extends BaseChartRenderer<VolumeEntity> {
  ...
  void drawText(Canvas canvas, VolumeEntity data, double x) {
    TextSpan span = TextSpan(
      children: [
        TextSpan(text: "VOL:${NumberUtil.volFormat(data.vol)}    ", style: getTextStyle(chartColors.volColor,this.chartStyle.defaultTextSize)),
        TextSpan(text: "MA5:${NumberUtil.volFormat(data.MA5Volume)}    ", style: getTextStyle(chartColors.ma5Color,this.chartStyle.defaultTextSize)),
        TextSpan(text: "MA10:${NumberUtil.volFormat(data.MA10Volume)}    ", style: getTextStyle(chartColors.ma10Color,this.chartStyle.defaultTextSize)),
      ],
    );
