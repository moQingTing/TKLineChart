  ...
  void drawText(Canvas canvas, CandleEntity data, double x) {
    ...
    if (state == MainState.ma) {
      span = TextSpan(
        children: [
          if (data.MA5Price != 0)
            TextSpan(text: "MA5:${format(data.MA5Price)}    ", style: getTextStyle(chartColors.ma5Color,chartStyle.defaultTextSize)),
          if (data.MA10Price != 0)
            TextSpan(text: "MA10:${format(data.MA10Price)}    ", style: getTextStyle(chartColors.ma10Color,chartStyle.defaultTextSize)),
          if (data.MA30Price != 0)
            TextSpan(text: "MA30:${format(data.MA30Price)}    ", style: getTextStyle(chartColors.ma30Color,chartStyle.defaultTextSize)),
        ],
      );
      ...
      span = TextSpan(
        children: [
          if (data.mb != 0)
            TextSpan(text: "BOLL:${format(data.mb)}    ", style: getTextStyle(chartColors.ma5Color,chartStyle.defaultTextSize)),
          if (data.up != 0)
            TextSpan(text: "UP:${format(data.up)}    ", style: getTextStyle(chartColors.ma10Color,chartStyle.defaultTextSize)),
          if (data.dn != 0)
            TextSpan(text: "LB:${format(data.dn)}    ", style: getTextStyle(chartColors.ma30Color,chartStyle.defaultTextSize)),
        ],
      );
    }
    if (span == null) return;
    ...
    tp.layout();
    final size = tp.size;
    tp.paint(canvas, Offset(x, chartRect.top - topPadding + size.height/2));
  }
